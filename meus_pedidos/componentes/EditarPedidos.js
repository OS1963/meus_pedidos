    ...
    return(
      ...
      keyboardVerticalOffset={30}>
        ...
        <View style={estilo.form}>
          ...
          autoFocus={true}
          onChangeText={nome => setPedido({...pedido, nome})}
          value={pedido.nome}
          ...
          <MaskInput
          style={estilo.inputs}
          onChangeText={telefone => setPedido({...pedido, telefone})}
          ...
          <TextInput
          style={estilo.inputs}
          onChangeText={servico => setPedido({...pedido, servico})}
          ...
          <MaskInput
          style={estilo.inputs}
          onChangeText={inicio => setPedido({...pedido, inicio})}
          value={pedido.inicio}
          ...
          <MaskInput
          style={estilo.inputs}
          onChangeText={previsao_entreg => setPedido({...pedido, previsao_entreg })}
